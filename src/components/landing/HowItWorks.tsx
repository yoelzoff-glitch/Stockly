...
export function HowItWorks() {
  ...
  return (
    <section id="como-funciona" className="py-20 md:py-28 border-b border-[rgba(0,57,104,0.10)] bg-white">
          ...
          {steps.map((step, idx) => {
            ...
            return (
              <FadeUp key={step.num} delay={0.1 + idx * 0.1}>
                <div className="h-full bg-[rgba(0,57,104,0.02)] rounded-2xl border border-[rgba(0,57,104,0.12)] p-7 sm:p-8 flex flex-col justify-between shadow-2xs hover:shadow-xs hover:border-[rgba(0,223,219,0.50)] transition-all duration-200">
                  <div>
                    <div className="flex items-center justify-between mb-6">
                      <span className="text-3xl font-extrabold text-[#003968] tabular-nums">
                        {step.num}
                      </span>
                      <div className="w-12 h-12 rounded-xl bg-white border border-[rgba(0,57,104,0.12)] flex items-center justify-center text-[#003968] shadow-2xs">
                        <Icon className="w-5 h-5 text-[#003968]" />
                      </div>
                    </div>

                    <h3 className="text-xl font-bold text-[#002B4D] mb-2.5">
                      {step.title}
                    </h3>
                  ...
                  <div className="pt-6 mt-6 border-t border-[rgba(0,57,104,0.10)]">
                    <span className="text-[11px] font-mono text-[rgba(0,43,77,0.68)]">
                      Paso {step.num} de 03
                    </span>
                  </div>
                </div>
