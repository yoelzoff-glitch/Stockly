        ...
        <div className="relative z-10">
          ...
          <div className="mt-20 max-w-lg">
            ...
            <p className="text-lg text-slate-300 leading-relaxed">
              "Desde que usamos Stockly, nuestro equipo dejó de perder tiempo en cálculos de rentabilidad y Excel manuales. La plataforma hace todo por nosotros, y el asistente de IA es una locura."
            </p>
          ...
          <form action={formAction} className="space-y-5 mt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                >
                  <option value="starter">Starter ($25 USD - 7 días gratis)</option>
