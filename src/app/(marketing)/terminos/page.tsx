      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200/80 space-y-8 prose prose-slate max-w-none">
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-600 leading-relaxed">
              Para cualquier consulta sobre estos Términos de Servicio, puede comunicarse con nuestro equipo de soporte a través de la sección de Ayuda en el panel de control o por correo electrónico a <span className="font-semibold text-indigo-600">soporte@libretax.com</span>.
            </p>
          </section>
        </div>
      </div>
