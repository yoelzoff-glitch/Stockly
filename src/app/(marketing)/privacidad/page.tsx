        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-200/80 space-y-8 prose prose-slate max-w-none">
          <section className="space-y-4">
            ...
            <p className="text-slate-600 leading-relaxed">
              En LibretaX, su privacidad y la seguridad de los datos de su negocio de comercio electrónico son nuestra máxima prioridad. Esta Política de Privacidad describe cómo recopilamos, utilizamos, almacenamos y protegemos la información cuando usted se registra y utiliza nuestra plataforma y asistente virtual de WhatsApp.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 text-slate-600 space-y-2">
              ...
              <li><strong>Información del Asistente (WhatsApp/Web):</strong> Almacenamos de forma temporal los mensajes y audios que usted envía a su número de asistente de LibretaX únicamente con el fin de interpretar sus intenciones operativas y procesar las órdenes solicitadas mediante nuestra IA.</li>
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-600 leading-relaxed">
              LibretaX **nunca venderá, alquilará ni comercializará sus datos de ventas, clientes, proveedores o información comercial con terceros**.
            </p>
            <p className="text-slate-600 leading-relaxed">
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-600 leading-relaxed">
              Usted tiene derecho a solicitar el acceso, rectificación, portabilidad o eliminación total de sus datos almacenados en LibretaX en cualquier momento. Si decide cancelar su cuenta, todos los tokens de acceso OAuth y registros relacionados con su negocio serán eliminados permanentemente de nuestros servidores activos en un periodo no mayor a 30 días hábiles.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-slate-600 leading-relaxed">
              Si tiene alguna pregunta, inquietud o reclamación relacionada con esta Política de Privacidad, puede ponerse en contacto con nuestro Oficial de Protección de Datos en <span className="font-semibold text-indigo-600">privacidad@libretax.com</span>.
            </p>
          </section>
        </div>
      </div>
