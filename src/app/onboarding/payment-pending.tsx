      ...
      <Card className="w-full max-w-md border-orange-200 bg-orange-50/50">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-orange-700/80">
            Para continuar configurando tu empresa y acceder al plan <strong>LibretaX {plan.charAt(0).toUpperCase() + plan.slice(1)}</strong>, necesitas completar tu pago en Mercado Pago.
          </CardDescription>
        </CardHeader>
        <CardContent>
