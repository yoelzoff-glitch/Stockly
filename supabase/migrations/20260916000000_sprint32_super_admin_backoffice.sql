...
VALUES
  (
    'starter',
    'Starter',
    'Para pequeños vendedores que inician el orden de su operativa.',
    49.99,
    499.99,
    1,
    1,
    '{"sku_limit": 100, "ai_actions": 500, "automation_limit": 250, "whatsapp_accounts": 1, "free_trial_days": 15, "fee_audit": true, "shipping_monitoring": true, "internal_stock": true}'::jsonb,
    true,
    true
  ),
  (
    'pro',
    'Pro',
    'Para catálogos medianos con volumen constante de ventas.',
    79.99,
    799.99,
    3,
    2,
    '{"sku_limit": 400, "ai_actions": 1500, "automation_limit": 800, "whatsapp_accounts": 2, "free_trial_days": 15, "ads_management": true, "priority_support": true}'::jsonb,
    true,
    true
  ),
  (
    'ultra',
    'Ultra',
    'Para cuentas de alto volumen con múltiples líneas de producto.',
    129.99,
    1299.99,
    10,
    5,
    '{"sku_limit": 1000, "ai_actions": 5000, "automation_limit": 1500, "whatsapp_accounts": 2, "free_trial_days": 15, "combo_tracking": true, "preventive_stock_alerts": true, "ads_management": true, "priority_support": true}'::jsonb,
    true,
    true
  )
